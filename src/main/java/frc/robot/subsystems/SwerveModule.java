...
public class SwerveModule {
    ...
    public SwerveModule(int DMID, int TMID, boolean driveMotorReversed, boolean turningMotorReversed,
        ...
        driveMotor = new TalonFX(DMID );
        turningMotor = new VictorSPX(TMID );
